...
void main() {
  ...
  group('DailyGlobeApiClient', () {
    late http.Client httpClient;
    late DailyGlobeApiClient apiClient;
    ...
    group('localhost constructor', () {
      ...
      test('has correct baseUrl', () async {
        ...
        final apiClient = DailyGlobeApiClient.localhost(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('default constructor', () {
      test('can be instantiated (no params).', () {
        expect(
          () => DailyGlobeApiClient(tokenProvider: tokenProvider),
          returnsNormally,
        );
      });
      ...
      test('has correct baseUrl.', () async {
        ...
        final apiClient = DailyGlobeApiClient(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('getArticle', () {
      ...
      test(
          'throws DailyGlobeApiMalformedResponse '
        ...
        expect(
          ...
          throwsA(isA<DailyGlobeApiMalformedResponse>()),
        );
      });

      test(
          'throws DailyGlobeApiRequestFailure '
        ...
        expect(
          () => apiClient.getArticle(id: articleId),
          throwsA(
            isA<DailyGlobeApiRequestFailure>()
