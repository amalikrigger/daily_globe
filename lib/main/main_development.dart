...
import 'package:daily_globe/main/bootstrap/bootstrap.dart';
import 'package:daily_globe/src/version.dart';
  ...
  bootstrap(
    (
      ...
      final packageInfoClient = PackageInfoClient(
        appName: 'Daily Globe [DEV]',
        packageName: 'com.globe.daily.dev',
